...
def main():
    ...
    # Uncomment to run: 
    # compare_policies(member_name="YourName")
    ...
    print("Running experiments for: Annemarie")
    hyperparameter_tuning_experiments(experiments_Annemarie, "Annemarie")
    # To run experiments for other members, uncomment the lines below:
    # hyperparameter_tuning_experiments(experiments_Joan, "Joan")
    # hyperparameter_tuning_experiments(experiments_michael, "Michael")
