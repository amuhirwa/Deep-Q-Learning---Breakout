...
| Rank | Experiment | Mean Reward | Std | LR | Gamma | Batch | Exploration | Key Insight |
|------|-----------|-------------|-----|-----|-------|-------|-------------|-------------|
| 🥇 1 | **Experiment_2_HighLR** | **23.10** | ±7.38 | 8.00e-04 | 0.970 | 32 | 0.12 | High LR (3.2x baseline) with moderate exploration optimal |
| 🥈 2 | Experiment_6_LargeBatch | 20.40 | ±4.27 | 2.00e-04 | 0.960 | 48 | 0.16 | Large batch provides excellent stability |
| 🥉 3 | Experiment_7_SmallBatch | 20.20 | ±5.02 | 3.00e-04 | 0.950 | 24 | 0.17 | Small batch enables fast learning |
| 4 | Experiment_10_Aggressive | 18.80 | ±6.01 | 1.20e-03 | 0.980 | 48 | 0.07 | Very high LR needs large batch for stability |
| 5 | Experiment_5_LowGamma | 18.10 | ±7.20 | 2.50e-04 | 0.910 | 32 | 0.22 | Low gamma suits immediate rewards |
| 6 | Experiment_4_HighGamma | 14.60 | ±3.93 | 2.00e-04 | 0.992 | 32 | 0.13 | Very high gamma over-emphasizes distant rewards |
| 7 | Experiment_9_FastExploration | 13.50 | ±5.92 | 2.50e-04 | 0.970 | 32 | 0.06 | Quick exploitation limits exploration |
| 8 | Experiment_1_Baseline | 13.00 | ±4.92 | 2.50e-04 | 0.960 | 32 | 0.15 | Conservative baseline reference |
| 9 | Experiment_8_SlowExploration | 13.00 | ±4.00 | 2.00e-04 | 0.960 | 32 | 0.28 | Excessive exploration limits exploitation |
| 10 | Experiment_3_LowLR | 11.00 | ±6.80 | 3.00e-05 | 0.940 | 32 | 0.18 | Very low LR severely limits learning |
...
| Rank | Experiment | Mean Reward | Std | LR | Gamma | Batch | Exploration | Key Insight |
|------|-----------|-------------|-----|-----|-------|-------|-------------|-------------|
| 🥇 1 | **Experiment_10_Aggressive** | **27.0** | ±7.62 | 1.00e-03 | 0.950 | 64 | 0.05 | **Best overall** - Aggressive settings work when balanced |
| 🥈 2 | Experiment_1_Baseline | 16.0 | ±1.79 | 1.00e-04 | 0.990 | 32 | 0.10 | Solid baseline with excellent stability |
| 🥉 3 | Experiment_5_VeryPatient | 15.2 | ±3.99 | 1.00e-04 | 0.999 | 32 | 0.10 | Very high gamma slightly overcomplicates |
| 4 | Experiment_9_ExtendedExploration | 15.1 | ±3.81 | 1.00e-04 | 0.990 | 32 | 0.50 | Extended exploration (50%) no better than standard |
| 5 | Experiment_6_TinyBatch | 12.2 | ±2.89 | 1.00e-04 | 0.990 | 8 | 0.10 | Tiny batch functional but suboptimal |
| 6 | Experiment_7_PureExploitation | 11.9 | ±4.53 | 1.00e-04 | 0.990 | 32 | 0.00 | Zero exploration drops performance 26% |
| 7 | Experiment_8_NoExploration | 11.7 | ±2.15 | 1.00e-04 | 0.990 | 32 | 0.05 | Minimal exploration insufficient |
| 8 | Experiment_4_Myopic | 7.1 | ±3.01 | 1.00e-04 | 0.500 | 32 | 0.10 | Gamma 0.5 too myopic even for Breakout |
| 9 | Experiment_2_VeryHighLR | 6.6 | ±2.20 | 1.00e-02 | 0.990 | 32 | 0.10 | LR 100x baseline causes catastrophic failure |
| 10 | Experiment_3_ZeroDiscount | 3.3 | ±1.85 | 1.00e-04 | 0.000 | 32 | 0.10 | Zero gamma completely fails - no sequential learning |
...
| Rank | Experiment | Mean Reward | Std | LR | Gamma | Batch | Exploration | Key Insight |
|------|-----------|-------------|-----|-----|-------|-------|-------------|-------------|
| 🥇 1 | **Experiment_10_Aggressive** | **20.1** | ±5.01 | 1.00e-03 | 0.990 | 64 | 0.08 | High LR with large batch achieves strong results |
| 🥈 2 | Experiment_2_HighLR | 19.0 | ±4.73 | 7.00e-04 | 0.980 | 32 | 0.15 | High LR (7x baseline) effective with standard batch |
| 🥉 3 | Experiment_9_FastExploration | 17.3 | ±5.73 | 2.50e-04 | 0.970 | 32 | 0.05 | Fast exploration with moderate LR balanced |
| 4 | Experiment_4_HighGamma | 15.9 | ±4.48 | 1.50e-04 | 0.995 | 32 | 0.12 | Very high gamma (0.995) decent but not optimal |
| 5 | Experiment_5_LowGamma | 15.8 | ±4.60 | 2.00e-04 | 0.900 | 32 | 0.30 | Low gamma (0.9) with extended exploration works |
| 6 | Experiment_6_LargeBatch | 15.3 | ±3.32 | 1.20e-04 | 0.970 | 64 | 0.18 | Low LR limits large batch advantage |
| 7 | Experiment_8_SlowExploration | 14.9 | ±3.11 | 1.00e-04 | 0.980 | 32 | 0.35 | Very slow exploration (35%) comparable to baseline |
| 8 | Experiment_1_Baseline | 14.3 | ±4.36 | 2.00e-04 | 0.950 | 64 | 0.20 | Baseline with large batch and slower exploration |
| 9 | Experiment_7_SmallBatch | 14.3 | ±3.69 | 3.00e-04 | 0.960 | 16 | 0.14 | Small batch (16) works with moderate LR |
| 10 | Experiment_3_LowLR | 7.7 | ±2.28 | 5.00e-05 | 0.920 | 64 | 0.25 | Very low LR (5e-5) severely limits learning |
