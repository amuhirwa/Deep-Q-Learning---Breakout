...
- **Exploration strategy wins:** The best run (`Exp5_LowGamma_Explorative`) pairs a relatively high learning rate (6e-4) with lower gamma (0.94) and slow epsilon decay (exploration_fraction 0.3, eps_end 0.1). Keeping exploration high for longer clearly helped Breakout.
...
- **Overall takeaway:** Moderate gamma with a generous exploration schedule. If you rerun sweeps, start from Exp5’s configuration and adjust around it.
